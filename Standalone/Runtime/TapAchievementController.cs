...
namespace TapTap.Achievement.Standalone {
    public class TapAchievementController : ITapAchievement
    {
        ...
        private const string SERVER_URL = "https://tds-tapsdk.cn.tapapis.com";
        ...
        private static void Reach(string id) {
            ...
            TapAchievementBean achievement = GetAchievement(id);
        ...
        #region Interface
        async void ITapAchievement.Init(TapConfig tapConfig)
        {
            await InitData();
        }
